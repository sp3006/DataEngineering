...
get_ipython().run_cell_magic('sql', '', 'SELECT sum(sales_amount) revenue\nFROM factSales')
...
get_ipython().run_cell_magic('sql', '', 'SELECT c.country, sum(sales_amount) revenue\nFROM factSales f\nJOIN dimcustomer c ON f.customer_key = c.customer_key\nGROUP BY c.country')
...
get_ipython().run_cell_magic('sql', '', 'SELECT d.month , sum(sales_amount) revenue\nFROM factSales f\nJOIN dimDate d ON f.date_key = d.date_key\nGROUP BY d.month')
